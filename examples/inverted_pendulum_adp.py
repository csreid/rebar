...
env = DiscreteActionWrapper(gym.make(env_name).env)
eval_env = DiscreteActionWrapper(gym.make(env_name))
eval_env.render()
sample_env = DiscreteActionWrapper(gym.make(env_name))
